...
public class CachingJpaLazyDataModel<T> extends JPALazyDataModel<T> implements Serializable {
    ...
    public static class Builder<T> {
        private final CachingJpaLazyDataModel<T> model;

        public Builder() {
            model = new CachingJpaLazyDataModel<>();
        }
        ...
        public CachingJpaLazyDataModel<T> build() {
